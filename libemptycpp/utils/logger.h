...
#include <libemptycpp/st_exports.h>
...
template <typename... T> void logger(T &&... args) {
  emptycpp::utils::LogManager::instance()->variadic_message(
      emptycpp::utils::LOG_MESSAGE_KIND::MESSAGE, args...);
}

template <typename... T> void logger_info(T &&... args) {
  emptycpp::utils::LogManager::instance()->variadic_message(
      emptycpp::utils::LOG_MESSAGE_KIND::INFO, args...);
}

template <typename... T> void logger_fatal(T &&... args) {
  emptycpp::utils::LogManager::instance()->variadic_message(
      emptycpp::utils::LOG_MESSAGE_KIND::FATAL, args...);
}
}
